...
func (x *RefundPaymentRequest) GetOrderId() int64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
const file_proto_payment_proto_rawDesc = "" +
	...
	"\rRefundPayment\x12\x1d.payment.RefundPaymentRequest\x1a\x1e.payment.RefundPaymentResponseB)Z'create-order-saga/proto/payment;paymentb\x06proto3"
